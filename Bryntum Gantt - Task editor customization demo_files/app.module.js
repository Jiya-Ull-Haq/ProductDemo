import { Combo, Grid, List, Gantt, ProjectModel, TaskModel } from '../../build/gantt.module.js?463310';
                                    ...
                                    name : {
                                        ...
                                        editor : {
                                            displayValueRenderer(taskRecord) {
                                                return taskRecord ? `${taskRecord.name} (${taskRecord.id})` : '';
                                            },
                                            listItemTpl(taskRecord) {
                                                return `${taskRecord.name} (${taskRecord.id})`;
                                            }
                                        }
                                    }
                                }
